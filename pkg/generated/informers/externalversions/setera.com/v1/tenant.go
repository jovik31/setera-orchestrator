...
type TenantInformer interface {
	...
	Lister() seteracomv1.TenantLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.SeteraV1().Tenants(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SeteraV1().Tenants(namespace).Watch(context.TODO(), options)
			},
		},
...
func (f *tenantInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apiseteracomv1.Tenant{}, f.defaultInformer)
}

func (f *tenantInformer) Lister() seteracomv1.TenantLister {
	return seteracomv1.NewTenantLister(f.Informer().GetIndexer())
}
